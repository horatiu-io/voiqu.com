...
import { Linkedin, Mail, Instagram, Music, Twitter, Phone, Facebook } from "lucide-react"
...
export default function Footer() {
  ...
  // Inline SVG for Reddit to ensure currentColor works
  const RedditIconSVG = (
    <svg
      version="1.0"
      ...
      fill="currentColor" // This will now be controlled by Tailwind's text-color
    >
      <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
        <path
          d="M4042 4699 c-153 -23 -312 -123 -392 -247 l-15 -23 -415 99 c-228 55
      ...
      27 53 91 122 136 146 23 12 102 35 146 41 3 1 32 -4 65 -10z m-2004 -240 l36 -11
      -126 -127 c-191 -190 -308 -379 -368 -593 -31 -111 -36 -112 -87 -18 -162
      297 -3 675 319 757 54 14 166 10 226 -8z m3591 10 c235 -49 412 -286 395 -529
      -6 -85 -36 -187 -74 -244 l-26 -39 -33 101 c-76 234 -240 476 -427 632 -37
      30 -62 59 -58 63 22 22 150 31 223 16z"
        />
        <path
          d="M1703 2556 c-210 -69 -306 -289 -211 -485 67 -139 235 -216 386 -177
      76 19 127 50 180 111 60 68 85 141 80 235 -6 131 -76 238 -193 295 -65 32
      -178 42 -242 21z"
        />
        <path
          d="M3185 2557 c-97 -33 -172 -98 -214 -187 -22 -46 -26 -69 -26 -145 0
      -76 4 -98 26 -145 65 -138 219 -218 368 -191 81 15 127 39 182 94 212 212 74
      570 -225 584 -41 1 -88 -3 -111 -10z"
        />
        <path
          d="M1743 1466 c-38 -17 -73 -69 -73 -109 0 -81 64 -138 264 -232 211
  ...
  return (
    <footer className="bg-[#0D0D0D] border-t border-gray-800 [content-visibility:auto]">
